...
function KoeleBergingen() {
  return (
   <ServiceTemple
   bgImage={bgImg}
   title={'Een koele berging voor professionals en particulieren'}
   desinfos={"Tot 50 jaar geleden was het vanzelfsprekend om producten vers te houden in een frisse kelder. Maar door betere isolatietechnieken beschikken steeds minder nieuwbouwwoningen over zo’n ruimte. Zijn opvolger? Dat is de koele berging. OptimaCool brengt u de “Cave Cool”, een zelf ontworpen klimaatsysteem dat voldoet aan al uw eisen. Compact, fluisterstil en nauwkeurig regelbaar. Bovendien maken we uw koele berging graag op maat!"}
 
   SleftH3={"Wat bewaart u in uw koele berging?"}
